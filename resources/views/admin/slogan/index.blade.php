    ...
    <div class="col-xs-12">
      <div class="box">
            ...
            @foreach($data as $key => $item)
              <tr>
                ...
                <td class="text-center with_dieuhuong">
                  <i class="fa fa-pencil fa-fw"></i><a href="backend/slogan/edit/{{$item->id}}?type={{ @$_GET['type'] }}">Edit</a>
                </td>
        ...
        <div class="box-footer col-md-12">
          <div class="row">
            <div class="col-md-6">
              <input type="button" onclick="javascript:window.location='backend/slogan/create?type={{ @$_GET[type] }}'" value="Thêm" class="btn btn-primary" />
